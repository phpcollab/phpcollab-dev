...
(1, 'files/index', NOW()),
(2, 'files/create', NOW()),
(3, 'files/read/comments', NOW()),
(4, 'files/update', NOW()),
(5, 'files/update/status', NOW()),
(6, 'files/update/comments', NOW()),
(7, 'files/update/published', NOW()),
(8, 'files/delete', NOW()),
(9, 'files_milestones/index', NOW()),
(10, 'files_milestones/create', NOW()),
(11, 'files_milestones/read/comments', NOW()),
(12, 'files_milestones/update', NOW()),
(13, 'files_milestones/delete', NOW()),
(19, 'files_tasks/index', NOW()),
(20, 'files_tasks/create', NOW()),
(21, 'files_tasks/read/comments', NOW()),
(22, 'files_tasks/update', NOW()),
(23, 'files_tasks/delete', NOW()),
(35, 'milestones/index', NOW()),
(36, 'milestones/create', NOW()),
(38, 'milestones/update', NOW()),
(39, 'milestones/update/date_start', NOW()),
(40, 'milestones/update/date_due', NOW()),
(41, 'milestones/update/date_complete', NOW()),
(42, 'milestones/update/status', NOW()),
(43, 'milestones/update/priority', NOW()),
(45, 'milestones/update/published', NOW()),
(46, 'milestones/delete', NOW()),
(47, 'notes/index', NOW()),
(48, 'notes/create', NOW()),
(50, 'notes/update', NOW()),
(51, 'notes/update/published', NOW()),
(52, 'notes/delete', NOW()),
(53, 'notifications/index', NOW()),
(54, 'notifications/create', NOW()),
(56, 'notifications/update', NOW()),
(57, 'notifications/delete', NOW()),
(58, 'organizations/index', NOW()),
(59, 'organizations/create', NOW()),
(61, 'organizations/update', NOW()),
(63, 'organizations/delete', NOW()),
(69, 'posts/create', NOW()),
(70, 'posts/delete', NOW()),
(71, 'projects/index', NOW()),
(72, 'projects/create', NOW()),
(74, 'projects/update', NOW()),
(75, 'projects/update/date_start', NOW()),
(76, 'projects/update/date_due', NOW()),
(77, 'projects/update/date_complete', NOW()),
(78, 'projects/update/status', NOW()),
(79, 'projects/update/priority', NOW()),
(81, 'projects/update/published', NOW()),
(82, 'projects/delete', NOW()),
(83, 'projects_members/index', NOW()),
(84, 'projects_members/create', NOW()),
(86, 'projects_members/update', NOW()),
(87, 'projects_members/delete', NOW()),
(103, 'tasks/index', NOW()),
(104, 'tasks/create', NOW()),
(106, 'tasks/update', NOW()),
(107, 'tasks/update/date_start', NOW()),
(108, 'tasks/update/date_due', NOW()),
(109, 'tasks/update/date_complete', NOW()),
(110, 'tasks/update/status', NOW()),
(111, 'tasks/update/priority', NOW()),
(113, 'tasks/update/published', NOW()),
(114, 'tasks/delete', NOW()),
(115, 'topics/index', NOW()),
(116, 'topics/create', NOW()),
(118, 'topics/update', NOW()),
(119, 'topics/update/status', NOW()),
(120, 'topics/update/priority', NOW()),
(121, 'topics/update/published', NOW()),
(122, 'topics/delete', NOW()),
(123, 'trackers/index', NOW()),
(124, 'trackers/create', NOW()),
(126, 'trackers/update', NOW()),
(127, 'trackers/delete', NOW());
...
(39, 'phpcollab/icons/published', 'eye', NOW()),
(40, 'phpcollab/icons/inteam', 'rocket', NOW()),
