<article class="title">
	<h2><a href="<?php echo $this->my_url; ?>organizations"><i class="fa fa-building-o"></i><?php echo $this->lang->line('organizations'); ?></a> / <i class="fa fa-plus"></i><?php echo $this->lang->line('create'); ?></h2>
	<ul>
	</ul>
</article>
<article>
	...
	<div class="column1">
		...
		<?php echo form_dropdown('org_owner', $dropdown_org_owner, set_value('org_owner', ''), 'id="org_owner" class="select required numeric"'); ?>
		</p>
		<p>
