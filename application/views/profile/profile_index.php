...
<article>
	...
	<div class="column half">
		...
		<?php if($this->phpcollab_member->mbr_datecreated) { ?><?php echo $this->my_library->timezone_datetime($this->phpcollab_member->mbr_datecreated); ?> (<span class="timeago" title="<?php echo $this->my_library->timezone_datetime($this->phpcollab_member->mbr_datecreated); ?>"></span>)<?php } else { ?>-<?php } ?>
		</p>
	</div>
</article>
