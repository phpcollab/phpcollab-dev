<article class="title">
	<h2><a href="&lt;?php echo $this->my_url; ?&gt;<?php echo $table; ?>"><?php if($icon) { ?><i class="fa fa-<?php echo $icon; ?>"></i><?php } ?>&lt;?php echo $this->lang->line('<?php echo $table; ?>'); ?&gt;</a> / <i class="fa fa-wrench"></i>&lt;?php echo $row-><?php echo $main_field; ?>; ?&gt;</h2>
	<ul>
