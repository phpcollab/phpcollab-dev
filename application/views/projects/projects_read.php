<article class="title">
	<h2><a href="<?php echo $this->my_url; ?>projects"><i class="fa fa-leaf"></i><?php echo $this->lang->line('projects'); ?></a> / <i class="fa fa-eye"></i><?php echo $row->prj_name; ?></h2>
	<ul>
...
<article>
	...
	<div class="column1 columnlast">
		...
		<?php if($row->prj_priority) { ?><?php echo $row->prj_priority; ?><?php } else { ?>-<?php } ?>
		</p>
		<p>
